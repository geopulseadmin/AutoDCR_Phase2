...
var caseTypeColors = {
    ...
    "Revised": "#40E0D0", // Turquoise outline for revised cases
...
//                                 // Check if the case type should have a blinking border
//                                 var additionalClass = (caseinformation_casetype === 'New' || caseinformation_casetype === 'Revised') ? ' blinking-border' : '';
                            
//                                 return L.marker(latlng, {
//                                     icon: L.divIcon({
//                                         className: 'custom-marker-icon' + additionalClass,  // Add blinking class if needed
//                                         html: '<div style="background: ' + gradient + '; width: 10px; height: 10px; border-radius: 50%; border: 2px solid ' + borderColor + ';"></div>'
//                                     })
//                                 });
//                             }
